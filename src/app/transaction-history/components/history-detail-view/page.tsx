...
export default function DetailView(props: propsType) {
  ...
  async function setAmount(quote: ResponseRapidXPath){
    debugger;
    const fromAmountValue = await utilityService.convertToNumber(quote?.data?.quote?.fromAmount, quote?.data?.route?.sourceTransaction?.fromToken?.decimal);
    const toAmountValue = await utilityService.convertToNumber(quote?.data?.quote?.toAmount, quote?.data?.route?.destinationTransaction?.toToken?.decimal);
    console.log(fromAmountValue, toAmountValue)
    setFromAmount(fromAmountValue?.toFixed(4));
    setToAmount(toAmountValue?.toFixed(4));
                        ...
                        <div className="col-md-5">
                          <div className="bg-white rounded p-3 text-center h-100">
                            ...
                            <div className="d-flex align-items-center justify-content-center mb-2">
                              ...
                              <span className="ms-2 badge bg-secondary">{props?.detailViewData?.sourceChainName}</span>
                            </div>
                        ...
                        <div className="col-md-5">
                          <div className="bg-white rounded p-3 text-center h-100">
                            ...
                            <div className="d-flex align-items-center justify-content-center mb-2">
                              ...
                              <span className="ms-2 badge bg-secondary">{props?.detailViewData?.destinationChainName}</span>
                            </div>
                            <strong className="d-block">{toAmount} {quoteDetail?.data?.route?.destinationTransaction?.toToken?.symbol}</strong>
                      ...
                      <div className="col-md-6">
                        <div className="inner-card p-3 bg-light border rounded h-100">
                          ...
                          <div className="small">
                            <div className="mb-2">
                              <span className="text-muted">Amount:</span>
                              <span className="float-end fw-semibold">{toAmount} {quoteDetail?.data?.route?.destinationTransaction?.toToken?.symbol}</span>
                            </div>
                            <div className="mb-2">
